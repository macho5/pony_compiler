...
struct SimplifyRedundantTranspose : public mlir::OpRewritePattern<TransposeOp> {
  ...
  matchAndRewrite(TransposeOp op,
    ...
    mlir::Value param = op.getOperand();
    ...
    TransposeOp inner_op = param.getDefiningOp<TransposeOp>();
    if(!inner_op) 
      return failure();
    ...
    mlir::Value inner_param = inner_op.getOperand();
    rewriter.replaceOp(op, inner_param);
    return success();
  }
};
